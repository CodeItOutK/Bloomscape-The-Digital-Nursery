...
import '../widgets/PlantSearchBox.dart';
...
class LandingPage extends StatefulWidget {
  ...
  static Route route(){
    return MaterialPageRoute(builder: (context)=>LandingPage(),settings: RouteSettings(name: routeName),);
  }
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<NurseryBloc, NurseryState>(
              builder: (context,state) {
                if(state is NurseryLoading){
                  return Center(
                ...
                if(state is NurseryLoaded){
                  return Padding(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          return NurseryCard(nursery : state.nurseries[index]);
                        }),
                  );
                }
                else{
